...
const PRESETS = ["MDX23C — Vocals/Drums/Bass/Other", "Demucs v4 — 4 stems", "Kim Vocal 2 — vocals + inst"];
  ...
  return (
    <div className="mx-auto max-w-[1600px] space-y-6 px-6 py-6">
      <header>
        ...
        <p className="mt-1 text-sm text-muted-foreground">Ultimate Vocal Remover stem separation.</p>
      </header>
        ...
        <ErrorState
          ...
          action={
            <div className="flex flex-wrap gap-2">
              <Button size="sm" variant="outline" asChild><a href="/settings">Open Settings</a></Button>
              <Button
          ...
          <div className="mt-4 space-y-4">
            ...
            <div>
              ...
              <div className="mt-2 grid grid-cols-2 gap-2">
                {ALL_STEMS.map((s) => (
                  <label key={s} className="flex items-center gap-2 rounded border border-border bg-surface-2 px-2 py-1.5 text-xs">
                    <Checkbox checked={selectedStems.includes(s)} onCheckedChange={() => toggleStem(s)} />
            ...
            <div className="flex justify-end gap-2">
              <Button variant="outline" onClick={() => bridge.openUvr().catch((e: Error) => toast.error(e.message))}>
                Open UVR
              </Button>
